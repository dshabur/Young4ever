...
// Получение статей категории "Уход за волосами"
try {
...
<head>
    ...
    <title>Уход за волосами - Young Forever</title>
...
<body>
        ...
        <div class="header-container">
            <nav>
                <ul>
                    ...
                    <li class="large-text"><a href="haircare.php" class="active">Уход за волосами</a></li>
    ...
    <div class="category-header">
        ...
        Здоровые волосы – это результат правильного ухода и заботы.  
        </p>
        <ul style="margin-top: 30px; padding-left: 0; text-align: center; list-style: none;">
            <li>Мойте голову правильно – подбирайте шампунь по типу волос, избегайте горячей воды.</li>
            <li>Кондиционирование – используйте бальзамы и маски для увлажнения и питания.  </li>
            <li>Защита от тепла – перед укладкой наносите термозащитные средства.</li>
            <li>Расчесывание – начинайте с кончиков, используйте деревянные гребни или щетки с натуральной щетиной.</li>
            <li>Питание изнутри – ешьте больше белка, омега-3, витаминов А и Е.</li>
        </ul>
        <p style="margin-top: 30px; text-align: center;">Совет: Ограничьте использование фена и утюжков – давайте волосам отдых!</p>
    </div>
