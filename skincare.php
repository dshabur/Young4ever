...
// Получение статей категории "Уход за кожей"
try {
...
<head>
    ...
    <title>Уход за кожей - Young Forever</title>
...
<body>
        ...
        <div class="header-container">
            <nav>
                <ul>
                    ...
                    <li class="large-text"><a href="skincare.php" class="active">Уход за кожей</a></li>
    ...
    <div class="category-header">
        ...
        <div class="category-header">
            ...
            Кожа – это зеркало здоровья и молодости, поэтому ей необходим регулярный и правильный уход.
            </p>
            <ul style="margin-top: 30px; padding-left: 0; text-align: center; list-style: none;">
                <li>Очищение – используйте мягкие средства, соответствующие вашему типу кожи (гели, пенки, мицеллярная вода).</li>
                <li>Увлажнение – наносите крем или сыворотку с гиалуроновой кислотой, церамидами или глицерином.</li>
                <li>Защита от солнца – SPF-крем обязателен даже в пасмурную погоду.</li>
                <li>Питание – маски и масла помогут восстановить баланс и сияние.</li>
                <li>Эксфолиация – 1-2 раза в неделю используйте скрабы или пилинги для обновления кожи.</li>
            </ul>
            <p style="margin-top: 30px; text-align: center;">Совет: Пейте больше воды и следите за питанием – это основа здоровой кожи!</p>
        </div>
